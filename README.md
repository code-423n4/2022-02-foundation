...
![Alt text](artifacts/images/MarketplaceStateMachine.png?raw=true "Marketplace State Machine")
...
![Alt text](artifacts/images/UMLContractDiagram.png?raw=true "Contract UML")
